...
import { applyBodyFontPreference, applyThemePreference, applyUiFontPreference, readWebPreferences } from "./app/preferences.js";
...
applyUiFontPreference(initialPreferences.uiFont);
